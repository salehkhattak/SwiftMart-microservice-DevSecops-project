...
![SwiftMart website through ALB](docs/aws/screenshots/Browser%20showing%20SwiftMart%20homepage%20through%20ALB%20DNS.png)

### GitHub Actions CI/CD

![GitHub Actions successful run](docs/aws/screenshots/github%20action%20pipeline.png)

### Argo CD GitOps

![SwiftMart in Argo CD](docs/aws/screenshots/Resource%20tree%20showing%20Deployments%20and%20Services.png)
...
![Prometheus targets showing SwiftMart services UP](docs/aws/screenshots/Prometheus%20alerts%20page-9090alerts.png)

### Alertmanager

![Alertmanager UI](docs/aws/screenshots/Prometheus%20alerts%20page-9090alerts.png)

### CloudWatch Logs

![CloudWatch log streams showing SwiftMart pods](docs/aws/screenshots/cloudwatchlogs.png)

![Sample product-service log event in CloudWatch](docs/aws/screenshots/EKS%20on%20cloudwatch.png)
